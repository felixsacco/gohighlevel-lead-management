...
export const metadata: Metadata = {
  ...
  title: 'MyApproved™ - Identity-Checked Tradespeople Across the UK',
  description: 'Find identity-checked local tradespeople across the UK. Compare plumbers, electricians, roofers, builders & 33 trades. Free quotes, real reviews, ID-checked professionals. No obligation.',
  ...
  openGraph: {
    title: 'MyApproved™ - Identity-Checked Tradespeople Across the UK',
    description: 'Find identity-checked tradespeople across the UK. Free quotes, real reviews, ID-checked professionals. Plumbers, electricians, roofers & 33 trades.',
    url: baseUrl,
    siteName: 'MyApproved',
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'MyApproved™ - Identity-Checked Tradespeople Across the UK',
    description: 'Find identity-checked tradespeople across the UK. Free quotes, real reviews, ID-checked professionals.',
