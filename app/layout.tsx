...
export const metadata: Metadata = {
  ...
  title: 'MyApproved™ - Verified Tradespeople Across the UK',
  description: 'Find verified local tradespeople across the UK. Compare plumbers, electricians, roofers, builders & 33 trades. Free quotes, real reviews, verified professionals. No obligation.',
  ...
  openGraph: {
    title: 'MyApproved™ - Verified Tradespeople Across the UK',
    description: 'Find verified tradespeople across the UK. Free quotes, real reviews, verified professionals. Plumbers, electricians, roofers & 33 trades.',
    url: baseUrl,
    siteName: 'MyApproved',
    locale: 'en_GB',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'MyApproved™ - Verified Tradespeople Across the UK',
    description: 'Find verified tradespeople across the UK. Free quotes, real reviews, verified professionals.',
