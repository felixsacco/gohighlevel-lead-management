...
export default function TradespersonRegistration() {
  ...
  const validateForm = (): boolean => {
    ...
    } else if (formData.trade.length < 2) {
      newErrors.trade = "Trade/profession must be at least 2 characters";
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create new tradesperson account in database
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleInputChange("trade", e.target.value)
                    }
                    className={`h-12 text-base bg-white/10 border-2 ${
                      errors.trade
                        ? "border-red-400/50"
