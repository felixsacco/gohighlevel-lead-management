...
import { Eye, EyeOff, User, Mail, Phone, MapPin, Lock, ArrowLeft, CheckCircle } from 'lucide-react';
...
export default function MockClientRegistration() {
          ...
          <CardContent className="p-8 text-center">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-6">
                Your account has been created successfully. (Mock registration - no actual database save)
              </p>
            </div>
      ...
      <Card className="w-full max-w-2xl">
        <CardHeader className="text-center pb-6">
          ...
          <CardTitle className="text-3xl font-bold text-gray-900 mb-2">
            Create Client Account (Mock)
          </CardTitle>
          <p className="text-gray-600">
            Mock registration - no actual database connection
          </p>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-gray-600">
                ...
                <Link href="/login/client" className="text-blue-600 hover:text-blue-800 font-medium">
                  Login here
                </Link>
              </p>
            </div>
