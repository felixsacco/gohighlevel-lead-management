...
export default function PostJobPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="bg-gradient-to-br from-brand-navy via-brand-navy to-[#0A2463] text-white pb-20 pt-8 sm:pt-12">
      ...
      <Section>
        <Container size="wide">
          ...
          <div className="text-center mt-10">
            <AIQuoteTriggerButton className="inline-flex items-center justify-center gap-2 bg-brand-navy hover:bg-brand-navy text-white font-bold px-8 py-4 text-base rounded-xl transition-colors">
