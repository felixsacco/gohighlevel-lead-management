      ...
      <section className="bg-brand-slate py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 lg:p-12 space-y-10 text-slate-600 text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>1. Acceptance of Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>2. About MyApproved</h2>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>3. Account Registration</h2>
              <h3 className="font-extrabold text-brand-navy mb-1.5" style={{ fontWeight: 800 }}>All users must:</h3>
              ...
              <h3 className="font-extrabold text-brand-navy mb-1.5" style={{ fontWeight: 800 }}>Tradespeople must additionally provide:</h3>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>4. Client Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>5. Tradesperson Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>6. Prohibited Conduct</h2>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>7. Disclaimers</h2>
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-4">
                <div className="flex items-start gap-2">
                  <AlertTriangle className="w-4 h-4 text-amber-700 mt-0.5 shrink-0" />
                  <p className="text-slate-600 text-sm"><strong className="text-brand-navy">Important:</strong> MyApproved is a platform service. We verify tradespeople's credentials, but we do not supervise, manage, or guarantee the quality, safety, or outcome of any work carried out. All contracts are directly between clients and tradespeople.</p>
                </div>
              </div>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>8. Dispute Resolution</h2>
              <p>If you have a dispute with a tradesperson, we encourage you to first attempt to resolve it directly. If that fails, contact our support team at <a href="mailto:support@myapproved.com" className="text-brand-navy hover:text-brand-amberDark underline">support@myapproved.com</a> and we will do our best to assist.</p>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>9. Changes to These Terms</h2>
            ...
            <div>
              <h2 className="text-xl font-extrabold text-brand-navy mb-3" style={{ fontWeight: 800 }}>10. Contact</h2>
              <p>For questions about these terms:</p>
              <p className="mt-2"><a href="mailto:support@myapproved.com" className="text-brand-navy hover:text-brand-amberDark font-medium underline">support@myapproved.com</a></p>
            </div>
