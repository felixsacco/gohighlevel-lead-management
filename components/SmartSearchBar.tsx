        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="relative md:col-span-1" ref={searchRef}>
            <div className="relative">
              <Input
                ...
                className="w-full pr-10 rounded-xl bg-[#1A1A1A] border border-white/10 text-white placeholder:text-white/30 focus-visible:border-brand-amber focus-visible:ring-0 text-sm h-12"
                required
          ...
          <div className="md:col-span-1">
            <Input
              ...
              className="w-full rounded-xl bg-[#1A1A1A] border border-white/10 text-white placeholder:text-white/30 focus-visible:border-brand-amber focus-visible:ring-0 text-sm h-12"
              required
          ...
          <Button
            type="submit"
            className="bg-brand-amber hover:bg-brand-amberDark text-[#111111] font-black h-12 rounded-xl transition-all duration-200 hover:scale-[1.02] flex items-center justify-center"
            disabled={isLoading}
            aria-busy={isLoading}
          >
            {isLoading ? (
