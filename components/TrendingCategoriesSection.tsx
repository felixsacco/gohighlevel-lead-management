      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-2">
            ...
            <div className="flex gap-4">
              {displayed.map((category) => {
                ...
                return (
                  ...
                  >
                    <div className="relative rounded-2xl bg-[#1A1A1A] border border-white/[0.07] hover:border-[#FFB800]/25 transition-all duration-300 p-6 h-full overflow-hidden hover:-translate-y-1">

                      {/* Subtle ambient glow on hover */}
                      <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFB800]/5 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                      ...
                      <div className="relative z-10 mb-5">
                        ...
                        <div className="inline-flex items-center gap-1.5 bg-[#FFB800]/10 border border-[#FFB800]/20 text-[#FFB800] px-2.5 py-1 rounded-full text-[0.65rem] font-bold mb-3">
                      ...
                      <div className="relative z-10 space-y-2 mb-5">
                        <div className="flex items-center gap-2 text-xs">
                          <div className="relative shrink-0">
                            ...
                            <div className="absolute inset-0 w-2 h-2 rounded-full bg-[#FFB800] animate-ping opacity-60" />
                          </div>
                      ...
                      {/* CTA */}
                      <Button className="relative z-10 w-full h-11 bg-[#FFB800] hover:bg-[#FFC933] text-[#111111] font-black text-sm rounded-xl transition-all duration-200 hover:scale-[1.02]">
                        Get Quote
                      </Button>
                    </div>
                  </Link>
          ...
          <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center">
            <button
              ...
              className="pointer-events-auto -ml-2 sm:ml-0 h-10 w-10 sm:h-11 sm:w-11 rounded-full border border-white/10 bg-[#1A1A1A] text-[#FFB800] shadow-lg hover:bg-[#232323] hover:border-[#FFB800]/25 transition-all duration-200 focus:outline-none flex items-center justify-center"
              aria-label="Previous"
            >
          ...
          <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center">
            <button
              ...
              className="pointer-events-auto -mr-2 sm:mr-0 h-10 w-10 sm:h-11 sm:w-11 rounded-full border border-white/10 bg-[#1A1A1A] text-[#FFB800] shadow-lg hover:bg-[#232323] hover:border-[#FFB800]/25 transition-all duration-200 focus:outline-none flex items-center justify-center"
              aria-label="Next"
            >
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 mt-10 mb-7">
          {['Plumber', 'Electrician', 'Builder', 'Painter', 'Roofer', 'Cleaner'].map((tag) => (
            <Link
              ...
              className="px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.08] text-white/55 text-xs font-medium hover:border-[#FFB800]/30 hover:text-white/85 transition-all duration-200"
            >
              {tag}
            </Link>
          ))}
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mb-8 text-xs text-white/35">
          <span className="inline-flex items-center gap-1.5">
            <Shield className="w-3.5 h-3.5 text-[#FFB800]" /> All Trades Verified
          </span>
          <span className="inline-flex items-center gap-1.5">
            <Shield className="w-3.5 h-3.5 text-[#FFB800]" /> Insurance Guaranteed
          </span>
          <span className="inline-flex items-center gap-1.5">
            <Star className="w-3.5 h-3.5 text-[#FFB800]" /> Rated 5.0 by 50,000+ Customers
          </span>
        </div>
        ...
        <div className="text-center mt-8">
          <Link
            ...
            className="inline-flex items-center px-6 py-3 rounded-xl bg-[#FFB800] hover:bg-[#FFC933] text-[#111111] font-black text-sm transition-all duration-200 hover:scale-[1.02] shadow-lg shadow-[#FFB800]/20"
          >
