...
const CTACardsSection = () => {
  ...
  return (
    <section className="py-20 bg-[#0A0A0A] relative overflow-hidden">
      {/* Ambient glow */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-[#FFB800]/4 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-[#FFB800]/3 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-[#FFB800]/10 border border-[#FFB800]/20 text-[#FFB800] px-4 py-2 rounded-full text-xs font-bold mb-5">
            <Target className="w-3.5 h-3.5" />
            <span className="tracking-[0.08em] uppercase">Choose Your Path</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-black tracking-tight text-white mb-4">
            Ready to Get{' '}
            <span className="text-[#FFB800]">Started?</span>
          </h2>
          <p className="text-lg text-white/45 max-w-2xl leading-relaxed">
            ...
            <span className="text-[#FFB800] font-semibold">Join thousands</span> who trust MyApproved.
          </p>
        </motion.div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {ctaCards.map((card, index) => {
            ...
            return (
              <motion.div
                key={card.id}
                className="group relative bg-[#161616] rounded-2xl border border-white/[0.06] hover:border-[#FFB800]/20 overflow-hidden transition-all duration-400"
              ...
              >
                ...
                <div className="relative h-44 overflow-hidden">
                  ...
                  {card.badge && (
                    <div className="absolute top-4 right-4">
                      <div className="bg-[#FFB800]/15 backdrop-blur-sm text-[#FFB800] px-2.5 py-1 rounded-full text-[0.65rem] font-black border border-[#FFB800]/25 tracking-wide">
                        {card.badge}
                      </div>
                    </div>
                  )}
                  ...
                  <div className="absolute top-4 left-4">
                    <div className="w-11 h-11 bg-[#FFB800]/15 backdrop-blur-sm rounded-xl flex items-center justify-center border border-[#FFB800]/25 group-hover:bg-[#FFB800]/25 transition-colors duration-300">
                      <IconComponent className="w-5 h-5 text-[#FFB800]" />
                    </div>
                  </div>
                ...
                <div className="p-5 space-y-4">
                  <div>
                    <h3 className="text-xl font-black text-white mb-2 group-hover:text-[#FFB800] transition-colors duration-300">
                      {card.title}
                    </h3>
                      ...
                      <Link
                        ...
                        className={`group/btn w-full inline-flex items-center justify-center px-5 py-3.5 rounded-xl font-black text-sm transition-all duration-200 hover:scale-[1.02] ${
                          card.variant === 'primary'
                            ? 'bg-[#FFB800] hover:bg-[#FFC933] text-[#111111] shadow-lg shadow-[#FFB800]/15'
                            : 'bg-transparent border border-[#FFB800]/40 text-[#FFB800] hover:bg-[#FFB800] hover:text-[#111111] hover:border-[#FFB800]'
                        }`}
                      >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#FFB800]/4 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none rounded-2xl" />
              </motion.div>
            );
          })}
        </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={value} className="text-center">
                  <div className="w-11 h-11 bg-[#FFB800]/10 border border-[#FFB800]/15 rounded-xl flex items-center justify-center mx-auto mb-3">
