  ...
  return (
    <section className="py-20 bg-gradient-to-br from-white via-blue-50/30 to-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-64 h-64 bg-brand-amber/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-20 w-80 h-80 bg-brand-navy/5 rounded-full blur-3xl"></div>
      </div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Enhanced header */}
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-brand-amber/10 text-brand-navy px-4 py-2 rounded-full text-sm font-semibold mb-4">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Real reviews from real customers across the UK. <span className="font-semibold text-brand-navy">Join thousands</span> who've found their perfect tradesperson.
          </p>
        ...
        <div className="relative">
            ...
            <div className="flex gap-6">
              {testimonials.map((testimonial) => (
                <div key={testimonial.id} className="flex-[0_0_100%] sm:flex-[0_0_50%] lg:flex-[0_0_33.333%] min-w-0">
                  <div className="group bg-white rounded-3xl border border-gray-100 shadow-lg hover:shadow-2xl transition-all duration-300 p-8 h-full hover:-translate-y-2 hover:border-brand-amber/30 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-brand-amber to-yellow-400 rounded-xl flex items-center justify-center shadow-lg">
                    ...
                    <div className="relative z-10 space-y-4">
                      ...
                      <div className="flex items-start gap-4 pt-4 border-t border-gray-100">
                        <div className="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-br from-brand-navy to-brand-navy flex items-center justify-center text-white font-bold shadow-lg">
                          {testimonial.image ? (
                            <img 
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-bold text-brand-navy text-lg">{testimonial.name}</div>
                        ...
                        {testimonial.projectValue && (
                          <div className="text-right">
                            <div className="font-bold text-brand-navy">{testimonial.projectValue}</div>
          ...
          <div className="flex items-center justify-between mt-8">
            <button
              ...
              className="h-12 w-12 rounded-full bg-white border-2 border-brand-navy/20 text-brand-navy shadow-xl hover:bg-brand-navy hover:text-white hover:shadow-2xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-brand-amber/30 hover:scale-110"
        ...
        <div className="mt-16 bg-gradient-to-r from-brand-navy/5 via-white to-brand-amber/5 rounded-3xl p-8">
          <div className="text-center mb-6">
            <h3 className="text-2xl font-black text-brand-navy mb-2">Trusted by Industry Leaders</h3>
            <p className="text-gray-600">Our platform is recognized and recommended by leading trade associations</p>
          </div>
          
          <div className="flex items-center justify-center gap-8 opacity-60">
            {/* Placeholder for company logos */}
            <div className="w-24 h-12 bg-gray-200 rounded-xl flex items-center justify-center text-xs font-bold text-gray-500">
              Google
            </div>
            <div className="w-24 h-12 bg-gray-200 rounded-xl flex items-center justify-center text-xs font-bold text-gray-500">
              Trustpilot
