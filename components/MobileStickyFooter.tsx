        ...
        {isExpanded && (
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-black text-brand-navy">Get Started Now</h3>
              <button
                onClick={() => setIsExpanded(false)}
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-brand-amber to-yellow-400 hover:from-yellow-400 hover:to-brand-amber text-brand-navy font-black py-4 rounded-xl text-lg shadow-lg mb-3"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              <Button
                ...
                className="bg-brand-navy hover:bg-brand-navy text-white font-bold py-3 rounded-xl"
              >
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-brand-amber to-yellow-400 text-brand-navy font-black px-4 py-2 rounded-xl shadow-lg"
            >
          ...
          <button
            ...
            className="w-10 h-10 bg-brand-navy text-white rounded-full flex items-center justify-center shadow-lg"
          >
