            ...
            <div className="space-y-4">
              ...
              <form onSubmit={handleSubscribe} className="space-y-2 pt-2">
                <input
                  ...
                  className="w-full rounded-xl border border-blue-200 bg-white px-4 py-2.5 text-sm text-[#0A2463] placeholder-blue-400 focus:border-blue-500 focus:outline-none"
                />
                <button
                  type="submit"
                  disabled={status === "loading"}
                  className="w-full rounded-xl bg-[#F5B301] px-4 py-2.5 text-sm font-bold text-[#0A2463] transition-colors hover:bg-[#E8A900] disabled:opacity-60"
                >
